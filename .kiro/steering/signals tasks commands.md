---
inclusion: fileMatch
fileMatchPattern: "{**/signals.py,**/tasks.py}"
---
...
Do the following for tasks.py so we can run tasks on runtime during dev.

# Provide task decorator based on environment
if settings.DEBUG:
    def task():
